 ...
 * Эта трансформация создает вихревые эффекты, изменяя координаты точки с использованием синусоидальных и косинусоидальных функций,
 * зависящих от квадрата расстояния точки от начала координат.
 */
public class SwirlTransformation implements Transformation {

    /**
     * Применяет вихревую трансформацию к координатам точки.
     * В этой трансформации новые координаты точки рассчитываются на основе синуса и косинуса от квадрата расстояния до центра,
     * что создает вихревой эффект.
     *
