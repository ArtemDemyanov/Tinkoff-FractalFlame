...
public class SphericalTransformation implements Transformation {
     ...
     * В этой трансформации координаты точки масштабируются обратно пропорционально квадрату
     * их расстояния от начала координат, что приводит к созданию эффекта проекции на сферу.
     *
